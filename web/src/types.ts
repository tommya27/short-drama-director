...
export type WorldStageProps = { scene: SceneSpec; snapshot: WorldSnapshot; events: SceneEvent[]; selectedActor: string | null; onActorSelect: (actorId: string) => void; motion?: StageMotion; activeEventId?: string | null; artifacts?: SceneArtifact[] };
